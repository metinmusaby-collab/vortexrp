...
public class EvCommand implements CommandExecutor {

    private final RPCore plugin;

    public EvCommand(RPCore plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        player.openInventory(new PropertyGUI(plugin, RPProperty.Tip.EV).getInventory());
        return true;
    }
}
